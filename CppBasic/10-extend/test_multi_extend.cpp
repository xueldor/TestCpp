...
namespace TestMutiExtend {
    ...
    public:
        ...
        //只要显式提供了构造函数(不管无参还是有参)，就必须提供virtual的析构函数。否则vs2008上面报Stack around the variable 'XXX' was corrupted。
    ...
    public:
        void printId() {
            ...
            //cout<<id<<endl;//二义性
//            cout<<Base::id<<endl;//两条路径到Base::id,这样也是有二义性的。尽管vs2008用的A::id,换个编译器就报错了
